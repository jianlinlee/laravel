...
<html lang="en">
<head>
    <title>标题名称 - Free HTML CSS Template</title>
    <meta charset="utf-8">
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="#feature" class="smoothScroll">特色</a></li>
                <li><a href="#about" class="smoothScroll">发展</a></li>
                <li><a href="#menu" class="smoothScroll">菜单</a></li>
                <li><a href="#team" class="smoothScroll">团队</a></li>
                <li><a href="#gallery" class="smoothScroll">产品</a></li>
                <li><a href="#contact" class="smoothScroll">加入我们</a></li>
            </ul>
        </div>
